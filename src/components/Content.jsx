...
const content = () => {
  return (
    ...
    <div className="relative z-10">
        <h1 className="px-40 py-3 mt-20 text-[44px] font-black ">COMPLETE <span className="bg-orange-400 p-1 rounded-2xl">SIGMA 9.0</span><br /> @JUST 299/-<br /> <span className="text-3xl"></span></h1>

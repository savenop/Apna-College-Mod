...
const content = () => {
  return (
    <div>
        <h1 className="px-45 py-10 text-[44px] font-black ">COMPLETE <span className="bg-orange-400 p-1 rounded-2xl">SIGMA 9.0</span><br /> COURSE <br /> <span className="text-3xl"></span></h1>

        <div className="px-45 flex flex-col gap-1 text-[15px]">
